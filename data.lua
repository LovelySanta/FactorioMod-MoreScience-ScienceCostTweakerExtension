...
require("prototypes.item.research-labs")

require("prototypes.entity.research-labs")

require("prototypes.recipe.science-intermediates")
require("prototypes.recipe.science-fluids")
require("prototypes.recipe.research-lab-intermediates")
require("prototypes.recipe.research-labs")

require("prototypes.technology.research-labs")
